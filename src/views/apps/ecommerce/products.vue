                ...
                <div class="col-sm-auto">
                  <div>
                    <router-link to="/ecommerce/add-product" class="btn btn-success"
                      ><i class="ri-add-line align-bottom me-1"></i> Add Product</router-link
                    >
                  </div>
                </div>
                <div class="col-sm">
                        ...
                        <tr class="gridjs-tr" v-for="(data, index) of resultQuery" :key="index">
                          ...
                          <td data-column-id="rating" class="gridjs-td">
                            <span
                              ><span class="badge bg-light text-body fs-12 fw-medium"
                                ><i class="mdi mdi-star text-warning me-1"></i>{{ data.rating }}</span
                              ></span
                            >
                          </td>
                          <td data-column-id="published" class="gridjs-td">
                            <span
                              ...
                              }}<small class="text-muted ms-1">{{ data.publishedDate[1] }}</small></span
                            >
                          </td>
                            ...
                            <span>
                              <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li>
                                    <router-link class="dropdown-item" to="/ecommerce/product-details"
                                      ><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</router-link
                                    >
                                  </li>
                                  <li>
                                    <router-link class="dropdown-item" to="/ecommerce/add-product"
                                      ><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</router-link
                                    >
                                  </li>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                          <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal" id="btnNo">
                            Close
                          </button>
